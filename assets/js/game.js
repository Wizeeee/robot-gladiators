...
var fight = function (enemy) {
  while (playerInfo.health > 0 && enemy.health > 0) {
    ...
    var pdamage = randomNumber(playerInfo.attack - 3, playerInfo.attack);
    ...
    var edamage = randomNumber(enemy.attack - 3, enemy.attack);
...
var shop = function () {
  ...
  var shopOptionPrompt = window.prompt(
    "Would you like to REFILL your health, UPGRADE your attack, or LEAVE the store? Please enter one of the following number: '1 for REFILL', '2 for UPGRADE', or '3 for LEAVE' to make a choice."
  );

  // The parseInt() method converts strings to integers.
