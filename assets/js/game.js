...
var fight = function (enemy) {
  ...
  while (playerInfo.health > 0 && enemy.health > 0) {
    if (isPlayerTurn) {
      ...
      // remove enemy's health by subtracting the amount set randomly in the playerInfo.attack variable
      ...
      // remove players's health by subtracting the amount set randomly in the enemy.attack variable
